    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="https://tarunkotagiri.github.io/idk/" target="_blank"><img src="images/idk_logo.png" alt="" height="100px"></a></div>
                    ...
                    <form action="includes/signup1.inc.php" method="post" id="signup_form">
                      ...
                      if (isset($_GET['errorp'])){
                        ...
                        if ($_GET['signup']=="success")
                          echo '<div style="color:green;">Signup Successful ! Welcome to IDK ></div>';
                      }
                       ?>
        ...
        <div class="row">
          ...
          <div class="owl-carousel col-12 nonloop-block-14">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <img src="images/vr_3.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="course-inner-text py-4 px-4">
                ...
                <p>Rule the future by being ahead of visual province.</p>
              </div>
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <img src="images/cyb_9.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="course-inner-text py-4 px-4">
                <span class="course-price">$0</span>
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Cyber Security</a></h3>
                <p>Never let others mock you by being ahead of your game !</p>
              </div>
              <div class="d-flex border-top stats">
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center"  data-aos="fade-up" data-aos-delay="">
            ...
            <p>We aim to make learning LIMITLESS by unlocking the all supreme visual dimension.</p>
          </div>
        </div>
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="d-flex align-items-center custom-icon-wrap mb-3">
              ...
              <div><h3 class="m-0">Stay ahead of yourselves</h3></div>
            </div>

            <div class="d-flex align-items-center custom-icon-wrap">
              <span class="custom-icon-inner mr-3"><span class="icon icon-university"></span></span>
              <div><h3 class="m-0">Understand it once, and never ForGET!</h3></div>
            </div>
        ...
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 mr-auto order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="d-flex align-items-center custom-icon-wrap mb-3">
              <span class="custom-icon-inner mr-3"><span class="icon icon-graduation-cap"></span></span>
              <div><h3 class="m-0">Easy to Understand.</h3></div>
            </div>

            <div class="d-flex align-items-center custom-icon-wrap">
              <span class="custom-icon-inner mr-3"><span class="icon icon-university"></span></span>
              <div><h3 class="m-0">Easy to Explain.</h3></div>
            </div>
        ...
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="d-flex align-items-center custom-icon-wrap mb-3">
              <span class="custom-icon-inner mr-3"><span class="icon icon-graduation-cap"></span></span>
              <div><h3 class="m-0">Knowledge * Action = POWER</h3></div>
            </div>

            <div class="d-flex align-items-center custom-icon-wrap">
              <span class="custom-icon-inner mr-3"><span class="icon icon-university"></span></span>
              <div><h3 class="m-0">We take you the level beyond next!</h3></div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              ...
              <div class="py-2">
                <h3 class="text-black">G Vivek</h3>
                <p class="position">Cyber Security Expert</p>
                <p>Worked with countless agencies to secure and Defend many cyber attacks.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="teacher text-center">
              <!-- <img src="images/Me.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4"> -->
              <div class="py-2">
                <h3 class="text-black">Tarun Kotagiri</h3>
                <p class="position">Virtual Reality Researcher</p>
                <p>Over an year of experience in Tweaking with VR/AR. Challenge to tranform his students.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="teacher text-center">
              ...
              <div class="py-2">
                <h3 class="text-black">P Sushma</h3>
                <p class="position">AI Engineer</p>
                <p>Leading expert in the domain of AI, taught many students over the years.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            ...
            <h3 class="mb-4">Thanuj</h3>
            <blockquote>
              <p>&ldquo; I was struggling with my studies but it all changed when I learned about IDK, I'm now a senior software engineer making a 6 figure salary per year.This website is a real game changer. &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-4 ml-auto align-self-start"  data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="p-4 rounded bg-white why-choose-us-box">
              ...
              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                ...
                <div><h3 class="m-0">Introducing World class technology</h3></div>
              </div>

              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
                <div><h3 class="m-0">Top Tier Professionals</h3></div>
              </div>

              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-graduation-cap"></span></span></div>
                <div><h3 class="m-0">Best Visuals</h3></div>
              </div>
              ...
              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-graduation-cap"></span></span></div>
                <div><h3 class="m-0">Highly Personalised</h3></div>
              </div>

              <div class="d-flex align-items-center custom-icon-wrap custom-icon-light">
                <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
                <div><h3 class="m-0">24/7 Support</h3></div>
              </div>
          ...
          <div class="col-md-7">
            ...
            <form method="post" action="index.php#contact-section" data-aos="fade" id="contact_form">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <a href="https://tarunkotagiri.github.io/idk/" class="btn btn-primary py-3 px-5 btn-block btn-pill" target="_blank">About Us</a>
              </div>
              </div>
    ...
    <footer class="footer-section bg-white">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <h3>About IDK</h3>
            <p>An E-Learning platform rich of resources, We make learning LIMITLESS by expanding your imagination.</p>
          </div>
