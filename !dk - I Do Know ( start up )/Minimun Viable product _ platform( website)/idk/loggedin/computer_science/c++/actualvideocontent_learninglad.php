 ...
 <body>
  ...
  <?php
      ...
      if (isset($_GET['video'])){
        switch ($_GET['video']) {
          case '1':
            $lien="https://www.youtube.com/embed/x39je8UaluI";  
            $nom_vid="Advanced Mathematics | A visualized Approach";
            $chapitre="0";
            break;
          case '2':
                ...
                case '0':
                  ...
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="actualvideocontent_learninglad.php?video=1">&#10170  Advanced Mathematics | A Visualised Approach</a><br>
